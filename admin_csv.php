...
/*
 *		module   : admin_csv.php
 *		projet   : la page d'exportation des log d'erreurs
 *
 *		version  : 1.0
 *		auteur   : laporte
 *		creation : 11/11/10
...
<?php
	...
	if ( $auth[0] == 255 ) {
		$query  = "select _text from admin_log ";
		$query .= "where _IDimport = '".@$_GET["id"]."' ";
		$query .= "order by _IDlog desc";
