...
<table summary="" border="1" width="100%" cellpadding="5">
  <tr>
     <td  align="center" style="width:20%;background-color:<?php print($_SESSION["CfgColor"]); ?>">
...
?>
        ...
        <tr>
          ...
          <td valign="middle"><?php print($msg->read($EDT_VALIDATE)); ?></td>
        </tr>
	</table>
