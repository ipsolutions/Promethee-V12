...
"choose a _CLASS:",
"all _CLASSes",
"Switch to former _STUDENT",
"Switch back to _STUDENT",
"Give a connection login",
"Validate changes.",
"all categories",
...
"<strong>Phone:</strong>",
"<strong>Beware:</strong> the datas must correspond to name@organisation.domain.",
"<strong>Email:</strong>",
...
"Refresh",
"<strong>_STUDENT List::%1</strong>",
"<strong>Former _STUDENT::%1</strong>",
"to cancel these %1",
...
"Options",
"Status",
"O:Valid,N:Former pupil,A:Awaiting,D:Resigning,E:Excluded",
"CSV export",
"<strong>ID #:</strong>",
"<strong>Zip</strong>",
"<strong>City</strong>",
