...
"Le tableau ci-dessous indique l'état des différentes installations et mises à jour de la plate-forme.",
...
"page précédente",
"
forbidden.php : accès refusé,
user_login.htm : demande d'identification,
user_new.htm : création de compte,
user_account.htm : accès au compte utilisateur,
...
postit_post.htm : création d'un nouveau post-it,
postit_visu.htm : visualisation des post-it,
postit.htm : Affichage des Post-it,
gallery_theme : création d'un nouveau thème d’une photothèque,
gallery_new.htm : création d'une nouvelle galerie,
...
spip_post.htm : création d'un nouvel article,
spip_new.htm : création d'une nouvelle publication en ligne,
spip_add.htm : création d'une dépêche,
spip_addlink.htm : ajout d'un lien sur une dépêche,
spip_search.htm : recherche dans les publications en ligne,
spip.htm : Lecture des publications en ligne,
stats_dba.htm : liste des bases de données installées,
stats_items.htm : liste des articles par auteurs,
stats.htm : Statistiques générales,
agenda_new.htm : création d'une nouvel agenda,
...
agenda_visu.htm : Accès au campus virtuel,
reservation_post.htm : demande de réservation,
reservation.htm : affichage des Réservations,
...
ctn.htm : Cahier de texte numérique,
...
motd.htm : liste des messages envoyé,
...
config_dba.htm : gestion de la base de données,
config_skin.htm : gestion des revêtements,
...
etp.htm : Espace Numérique,
quizz.htm : Accès au quizz,
exam_gestion.htm : gestion des résultats aux examens,
exam_new.htm : saisie des résultats aux examens,
exam_visu.htm : visualisation des résultats aux examens,
absent_show.htm : Absences individuelles,
absent_visu.htm : Absences des groupes,
edt.htm : Emplois du temps,
carnet_visu.htm : affichage du carnet à points des _STUDENT,
carnet.htm : affichage du Carnet à points,
retenu_visu.htm : affichage du détail des consignes des _STUDENT,
